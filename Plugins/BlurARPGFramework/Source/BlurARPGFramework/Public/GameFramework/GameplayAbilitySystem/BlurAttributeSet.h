...
public:
	...
	// 生命。
	UPROPERTY(BlueprintReadOnly, Category = "Blur ARPG Framework | Attribute Set", ReplicatedUsing = OnRep_Health)
	FGameplayAttributeData Health;
	ATTRIBUTE_ACCESSORS(UBlurAttributeSet, Health)

	UPROPERTY(BlueprintReadOnly, Category = "Blur ARPG Framework | Attribute Set", ReplicatedUsing = OnRep_MaxHealth)
	FGameplayAttributeData MaxHealth;
	ATTRIBUTE_ACCESSORS(UBlurAttributeSet, MaxHealth)

	// 耐力。
	UPROPERTY(BlueprintReadOnly, Category = "Blur ARPG Framework | Attribute Set", ReplicatedUsing = OnRep_Stamina)
	FGameplayAttributeData Stamina;
	ATTRIBUTE_ACCESSORS(UBlurAttributeSet, Stamina)

	UPROPERTY(BlueprintReadOnly, Category = "Blur ARPG Framework | Attribute Set", ReplicatedUsing = OnRep_MaxStamina)
	FGameplayAttributeData MaxStamina;
	ATTRIBUTE_ACCESSORS(UBlurAttributeSet, MaxStamina)

	// 怒气。
	UPROPERTY(BlueprintReadOnly, Category = "Blur ARPG Framework | Attribute Set", ReplicatedUsing = OnRep_Rage)
	FGameplayAttributeData Rage;
	ATTRIBUTE_ACCESSORS(UBlurAttributeSet, Rage)

	UPROPERTY(BlueprintReadOnly, Category = "Blur ARPG Framework | Attribute Set", ReplicatedUsing = OnRep_MaxRage)
	...
	// 攻击力。
	UPROPERTY(BlueprintReadOnly, Category = "Blur ARPG Framework | Attribute Set")
