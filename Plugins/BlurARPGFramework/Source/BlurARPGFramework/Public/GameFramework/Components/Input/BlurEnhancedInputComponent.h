...
#include "BlurEnhancedInputComponent.generated.h"

// 输入组件。
UCLASS()
class BLURARPGFRAMEWORK_API UBlurEnhancedInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()

public:
	template<class UserObject, typename CallbackFunc>
	void BindNativeInputAction(const UBlurDA_InputConfig* InInputConfig,
...
template <class UserObject, typename CallbackFunc>
void UBlurEnhancedInputComponent::BindNativeInputAction(const UBlurDA_InputConfig* InInputConfig,
	const FGameplayTag& InInputTag, ETriggerEvent TriggerEvent, UserObject* ContextObject, CallbackFunc Func)
{
