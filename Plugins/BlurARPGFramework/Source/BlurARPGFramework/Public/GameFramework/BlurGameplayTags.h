...
namespace BlurGameplayTags
{
	...
	BLURARPGFRAMEWORK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Input_ResetView);
	...
	BLURARPGFRAMEWORK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Common_Event_SwitchTarget_Triggered);
	BLURARPGFRAMEWORK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Common_Event_SwitchTarget_Completed);
	BLURARPGFRAMEWORK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Common_Event_ResetView);
