...
#include "GameFramework/Items/BlurProjectileBase.h"
...
// Sets default values
ABlurProjectileBase::ABlurProjectileBase()
{
...
void ABlurProjectileBase::BeginPlay()
{
	Super::BeginPlay();
...
void ABlurProjectileBase::OnProjectileHit(UPrimitiveComponent* HitComponent,
...
void ABlurProjectileBase::OnProjectileBeginOverlap(UPrimitiveComponent* OverlappedComponent,
...
void ABlurProjectileBase::OnHitTarget(AActor* OtherActor, const FHitResult& HitResult)
{
	bool bDestroy = false;
...
bool ABlurProjectileBase::HandleApplyProjectileDamage(APawn* InHitPawn, const FGameplayEventData& InPayload)
{
